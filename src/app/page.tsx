        ...
        <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 font-[family-name:var(--font-geist-sans)] mx-auto w-full max-w-screen-lg">
            <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
                <div className="flex items-center gap-4">
                    ...
                    <Link
                        href="/blog"
                        className="text-lg text-cyan-50 font-semibold">
                        Blog Page
                    </Link>
                </div>

                <h2 className="text-green-300">Advantages</h2>
                <ol className="flex flex-col gap-y-8 list-inside list-decimal text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)]">
                    ...
                    <li>
                        ...
                        migrations automatically, reducing the manual effort
                        required to manage changes
                    </li>
                    <li>
                        Type-Safety: Prisma ensures type-safety, helping to
                        catch errors early in the development process
                    </li>
                    <li>
                        Auto-Completion: The tool offers auto-completion
                        features, speeding up development and reducing the
                        likelihood of errors
                    </li>
                    <li>
                        CRUD Operations: Prisma supports full CRUD (Create,
                        Read, Update, Delete) operations, allowing developers to
                        interact with their data easily
                    </li>
                    <li>
                        Real-Time Database Subscriptions: It supports real-time
                        database subscriptions, enabling applications to react
                        to changes in the database instantly
                    </li>

                    <li>
                        ORM is designed to streamline database interactions,
                ...
                <h2 className="text-red-400">
                    Disadvantages of writing raw SQL quries
                </h2>
                <ol className="flex flex-col gap-y-8 list-inside list-decimal text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)]">
                    <li>
                        Security Risks: Raw SQL queries are more susceptible to
                        SQL injection attacks, where malicious users can
                        manipulate the query to gain unauthorized access to the
                        database. ORMs like Prisma use parameterized queries to
                        mitigate this risk.
                    </li>
                    <li>
                        Maintainability: Raw SQL can be harder to read,
                        understand, and maintain compared to ORM-based queries,
                        especially as the application grows. Using an ORM allows
                        for more readable and structured code.
                    </li>
                    <li>
                    ...
                    <li>
                        Type Safety: ORMs like Prisma offer type safety, helping
                        to catch errors at compile time. Raw SQL queries lack
                        this feature, increasing the risk of runtime errors.
                    </li>
                    <li>
                        Consistency: Using an ORM ensures consistent query
                        execution and data handling across the application,
                        while raw SQL can introduce inconsistencies if not
                        carefully managed.
                    </li>
                    <li>
